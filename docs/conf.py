# -*- coding: utf-8 -*-
#
# facemap-napari documentation build configuration file, created by
...
project = u'facemap-napari'
copyright = u'2015, Atika Syeda'
author = u'Atika Syeda'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'facemap-napari Documentation',
     [author], 1)
]
